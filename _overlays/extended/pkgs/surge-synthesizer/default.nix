...
, cairo, fontconfig, freetype, xorg, lato, xdg_utils, gnome3, libxkbcommon
, which, ncurses, utillinux, python3 }:
let
  vst2sdk = fetchzip {
...
in stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ cairo fontconfig freetype lato xdg_utils gnome3.zenity libxkbcommon ]
    ++ (with xorg; [
      libX11
      libxcb
      xcbutil
