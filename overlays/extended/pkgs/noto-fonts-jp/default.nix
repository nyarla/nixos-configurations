  ...
  fonts = [
    {
      ...
      sha256 = "1mxfi76g2bdbjwg7370ms2ifq53lvzrnf7kkk47928yljdd1z2i5";
    }
    {
      name = "NotoSansJP-Bold";
      sha256 = "0kr2fic5j9h6i7f3yqwck5lcxnfcv0amsw03kx7bgh3jcdjid1h4";
    }
    {
      name = "NotoSansJP-DemiLight";
      sha256 = "13kclx4p7vrn399hdivns0fwh7f8d150gjhl1xkmlxl128bz4ln0";
    }
    {
      name = "NotoSansJP-Light";
      sha256 = "04aaq4m76a76i0j0ngza9zafhnlm687cv5pij5dqlg4fg721fkcf";
    }
    {
      name = "NotoSansJP-Medium";
      sha256 = "1ply2zzp1z26caclwqbz3hmp6kvg3l8w9y3y6isn1sdmk8r8anx6";
    }
    {
      name = "NotoSansJP-Regular";
      sha256 = "19k1n95mipkzkzkx0ivqssca6b5m7sjyvzq46gjnmg76h6brrcwv";
    }
    {
      name = "NotoSansJP-Thin";
      sha256 = "1ndrnbf1cyjqgs61yypb71cni00ypr950qr4ri218dx4zlxx1d2w";
    }

    {
      name = "NotoSansMonoCJKjp-Bold";
      sha256 = "0vdqyvqvaj7jda0rr1bz7a05wjs1s08d4jippaffvrikhwnxpsly";
    }
    {
      name = "NotoSansMonoCJKjp-Regular";
      sha256 = "0wlrw6aclgg6fgz01vn55rf8jw0zban1zv114slv53qr1qlwrfva";
    }
...
in stdenv.mkDerivation rec {
  ...
  files = map ({ name, sha256 }:
    fetchurl {
      url =
        "https://raw.githubusercontent.com/googlefonts/noto-cjk/master/${name}.otf";
      inherit sha256;
    }) fonts;
