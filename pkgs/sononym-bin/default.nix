{ stdenv, lib, fetchurl, autoPatchelfHook, makeWrapper, alsa-lib, at-spi2-atk
, at-spi2-core, atk, cairo, cups, dbus, expat, fontconfig, freetype, gdk-pixbuf
, glib, gtk3, libappindicator-gtk3, libcap, libdbusmenu, libdrm, libglvnd
, libgpg-error, libjack2, libnotify, libsecret, libuuid, libxkbcommon, mesa
