{ pkgs, lib, ... }:
{
  ...
  hardware.fancontrol = {
    ...
    config = ''
      ...
      FCTEMPS=hwmon4/pwm2=hwmon2/temp1_input hwmon4/pwm1=hwmon4/temp2_input
      ...
      MAXTEMP=hwmon4/pwm2=60 hwmon4/pwm1=65
      MINSTART=hwmon4/pwm2=61 hwmon4/pwm1=15
      MINSTOP=hwmon4/pwm2=60 hwmon4/pwm1=14
      MINPWM=hwmon4/pwm2=60 hwmon4/pwm1=14
    '';
  };
