...
let
  script = fetchurl {
    url =
      "https://gist.githubusercontent.com/fatum12/941a10f31ac1ad48ccbc/raw/15b0b59bd4b372740ce944474ba103f6548b73f3/ttc2ttf.pe";
...
in stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ fontmerger fontforge ];
