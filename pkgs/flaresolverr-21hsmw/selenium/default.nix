# this file based on https://github.com/nix-community/nur-combined/blob/3e35cfa5b9685544cf1d2f7743f83c0957efd707/repos/xddxdd/pkgs/uncategorized/flaresolverr-21hsmw/selenium/default.nix
{
  lib,
  fetchFromGitHub,
  buildPythonPackage,
